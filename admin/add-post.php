...
if (strlen($_SESSION['adminid'] == 0)) {
  ...
  if (isset($_POST['Submit'])) {
    ...
    $packageduration = $_POST['packageduratiobn'];
    $Price = $_POST['Price'];
    $photo = $_POST['photo'];
    ...
    if (empty($category) || $category == 'NA') {
      ...
      // SQL query to insert the package
      ...
      $query->bindParam(':packageduratiobn', $packageduration, PDO::PARAM_STR);
