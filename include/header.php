<header class="header-section">
    <div class="header-top">
        <div class="row m-0">
            <div class="col-md-6 d-none d-md-block p-0"></div>
    ...
    <div class="header-bottom">
        <a href="index.php" class="site-logo" style="color:#fff; font-weight:bold; font-size:26px;">
            <img src="img/Union.png" alt="" width="200" height="100">
            <br />
        ...
        <div class="container">
            <ul class="main-menu">
                ...
                <?php else: ?>
                    ...
                    <li><a href="diet_recommendations.php">Diet Recommendations</a></li>
                <?php endif; ?>
